...
'''!Dataloader for the livestream version of the layout prediction
'''

class LivestreamData(data.Dataset):
    def __init__(self, config, phase='test', files='example/livestream/'):
        self.config = config
        self.phase = phase
